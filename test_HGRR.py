...
eval_dataset_ceilnet = datasets.CEILTestDataset(join(datadir, 'nature20'))
...
res = engine.eval(eval_dataloader_ceilnet, dataset_name='testdata_table2', savedir=join(result_dir, 'nature20'))
