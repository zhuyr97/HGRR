...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', type=str, default='errnet', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/gdata1/zhuyr/Deref/checkpoints_new', help='models are saved here')
