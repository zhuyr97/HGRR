...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_newloss', type=float, default=50, help='weight for vgg loss')
        self.parser.add_argument('--lambda_newloss_H', type=float, default=20, help='weight for vgg loss')
        self.isTrain = True