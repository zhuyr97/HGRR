...
class DRNet2(torch.nn.Module):
    def __init__(self, in_channels, out_channels, n_feats, n_resblocks, norm=nn.BatchNorm2d, 
    se_reduction=None, res_scale=1, bottom_kernel_size=3, pyramid=False,global_residual=True):
        super(DRNet2, self).__init__()
...
if __name__ == "__main__":
    ...
    fbar=DRNet2(in_channels=3, out_channels=3, n_feats= 144, n_resblocks=4,
        norm=None, res_scale=0.1, se_reduction=8, bottom_kernel_size=1, pyramid=True,global_residual=True)
