...
class DRNet3_re(torch.nn.Module):
...
if __name__ == "__main__":
    ...
    x = torch.randn(2, 3, 64, 64)        #.cuda()#.to(torch.device('cuda'))
    fbar=DRNet3(in_channels=3, out_channels=3, n_feats= 128, n_resblocks=4, se_reduction=8, bottom_kernel_size=1, pyramid=True)
